...
- **接口地址**: `https://nexus-saas-test-45653-8-1317958785.sh.run.tcloudbase.com/job/open-claw-create-job`
...
- **端点**: `https://nexus-saas-test-45653-8-1317958785.sh.run.tcloudbase.com/summary/content_by_phone`
...
- `token.txt` 文件存放 JWT token，位于脚本同目录
- 手机号必须是真实有效的中国大陆手机号
